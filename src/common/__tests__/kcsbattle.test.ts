...
describe('kcsbattle test', () => {
  ...
  it('case12: calculates sortie battle', () => {
    ...
    // case12: 連合艦隊(5隻+6隻) vs 通常艦隊(通常戦マス)
    // 先制対潜, 先制雷撃、砲撃
  ...
  it('case13: calculates sortie battle', () => {
    ...
    // case13: 連合艦隊(5隻+6隻) vs 通常艦隊(通常戦マス)
    // 開幕、先制雷撃、砲撃
  ...
  it('case14: calculates sortie battle', () => {
    ...
    // case14: 連合艦隊(5隻+5隻) vs 通常艦隊(対潜空襲マス)
    // 開幕、先制対潜、先制雷撃、砲撃
  ...
  it('case15: calculates sortie battle', () => {
    ...
    // case15: 連合艦隊(5隻+5隻) vs 通常艦隊(通常戦マス)
    // 開幕、先制雷撃、砲撃
  ...
  it('case16: calculates sortie battle', () => {
    ...
    // case16: 連合艦隊(5隻+5隻) vs 通常艦隊(通常戦マス)
    // 開幕、先制雷撃、砲撃
